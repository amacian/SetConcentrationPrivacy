...
public class XorSimpleNStringOpt implements StringFilter{
     ...
     */
    public static XorSimpleNStringOpt construct(Set<String> keys, int bitsPerFingerprint) {
        return new XorSimpleNStringOpt (keys, bitsPerFingerprint);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    public static XorSimpleNStringOpt construct(Set<String> keys, int bitsPerFingerprint, int tSize) {
        return new XorSimpleNStringOpt (keys, bitsPerFingerprint, tSize);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    XorSimpleNStringOpt(Set<String> keys, int bitsPerFingerprint) {
     ...
     * @return a new Filter with the selected parameters
     */
    XorSimpleNStringOpt(Set<String> keys, int bitsPerFingerprint, int tsize) {
